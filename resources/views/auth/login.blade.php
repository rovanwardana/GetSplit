...
<div class="flex min-h-screen">
    ...
    <div class="w-1/2 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-8">
        <div class="w-full max-w-md form-container rounded-3xl shadow-2xl p-10 slide-in">
            <div class="mb-8">
                <h2 class="text-lg font-medium text-gray-600 mb-2">Welcome Back!</h2>
                <h1 class="text-3xl font-bold text-[#071739] mb-2">Sign in</h1>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    @error('email') <p class="text-red-500 text-sm mt-1 flex items-center gap-1">
                ...
                <div class="space-y-2">
                    ...
                    @error('password') <p class="text-red-500 text-sm mt-1 flex items-center gap-1">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        </svg>
                        {{ $message }}
                ...
                <div class="space-y-6">
                    ...
                    <div class="text-center">
                        <p class="text-sm text-gray-500">
                            ...
                            <a href="{{ route('register') }}" class="text-[#4B6382] font-semibold link-hover ml-1">Create one now</a>
                        </p>
                    </div>
                </div>
            </form>
