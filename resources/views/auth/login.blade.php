    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <button 
                    type="submit"
                    class="w-full text-white font-semibold py-3 rounded-lg transition-all duration-200 transform hover:scale-[1.02] hover:shadow-lg hover:opacity-90" style="background-color: #071739;">
                ...
                <div class="text-center pt-4 border-t border-gray-200">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('register') }}" class="text-blue-600 font-semibold hover:text-blue-700 hover:underline ml-1">
                            Create one now
                        </a>
                    </p>
                </div>
